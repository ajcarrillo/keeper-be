...
export const DictionaryErrors = {
  ...
  "REQUESTED_TOKEN_INVALID": {
    code: 4001,
    codeString: "REQUESTED_TOKEN_INVALID",
    message: "REQUESTED_TOKEN_INVALID",
    httpStatusCode: 401,
  },
  ...
  "ITEM_DOES_NOT_EXIST_EXCEPTION": {
    code: 4004,
    codeString: "ITEM_DOES_NOT_EXIST_EXCEPTION",
    message: "EL REGISTRO NO EXISTE",
    httpStatusCode: 404,
  },
  "SCHEMA_VALIDATION": {
    code: 4005,
    codeString: "SCHEMA_VALIDATION",
    message: "ERROR GENERADO DEBIDO A QUE EL REGISTRO NO CUMPLE LA ESPECIFICACIÓN DEL ESQUEMA",
    httpStatusCode: 409,
  },
  "VALUES_REQUEST_NO_MATH": {
    code: 4006,
    codeString: "VALUES_REQUEST_NO_MATH",
    message: "NO CUMPLE CON LA ESPECIFICACIÓN DE LA REGLA",
    httpStatusCode: 404,
  },
  "CONTENT_DATA_AMBIGUITY": {
    code: 4007,
    codeString: "CONTENT_DATA_AMBIGUITY",
    message: "EL CONTENIDO ES AMBIGUO",
    httpStatusCode: 409,
  },
  "KEY_DUPLICATED": {
    code: 4008,
    codeString: "KEY_DUPLICATED",
  ...
  "SIMILARITY": { code: 4009, codeString: "SIMILARITY", message: "", httpStatusCode: 409 },
}
